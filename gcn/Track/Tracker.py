...
class Detection(object):
    ...
    """
    def __init__(self, tlbr, keypoints, confidence, keypoints2, keypoints3, cut_img):
        self.tlbr = tlbr
        self.keypoints = keypoints
        self.confidence = confidence
        self.keypoints2 = keypoints2
        self.keypoints3 = keypoints3
...
class Track:
    def __init__(self, mean, covariance, track_id, n_init, max_age=10, buffer=10):
        ...
        self.cf_cut_img = None
        self.cf_keypoints_cdm = None
        self.cf_keypoints_dnn = None
    ...
    def update(self, kf, detection):
        ...
        self.cf_cut_img = detection.cut_img
        self.cf_keypoints_cdm = detection.keypoints2
        self.cf_keypoints_dnn = detection.keypoints3
...
class Tracker:
    ...
    def _initiate_track(self, detection):
        ...
        self.tracks.append(Track(mean, covariance, self._next_id, self.n_init, self.max_age, buffer=self.max_age))
        self._next_id += 1
